...
public class RedisTest extends BaseTest {
	...
	/** 打印当前key的值 */
	public void printCurrValue(RedisTemplate redisTemplate, String key) {
	...
	public void testSet() {
		...
		// 求多个集合的交集
		redisTemplate.opsForSet().intersect( new ArrayList<String>(), new ArrayList<String>());
	...
	public void testZset() {
		...
		printTypedTuple(set);
		// 将zset1和zset2两个集合的 【 交集】  放入集合inter_zset
	...
	// redisTemplate.opsForHyperLogLog().add("HyperLogLog", "a", "b", "c", "d",
	// "a");
	...
	// System.err.println(size);
	// redisTemplate.opsForHyperLogLog().union("des_key", "HyperLogLog",
	// "HyperLogLog2");
