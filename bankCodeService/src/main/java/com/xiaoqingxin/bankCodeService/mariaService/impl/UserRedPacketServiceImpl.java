...
import com.xiaoqingxin.bankCodeService.mapper.UserRedPacketDao;
...
public class UserRedPacketServiceImpl implements UserRedPacketService {
	...
	@Override
	@Transactional(isolation = Isolation.READ_COMMITTED, propagation = Propagation.REQUIRED)
	public int grapRedPacketForVersionTimeRe(Long redPacketId, Long userId) {
		// 记录开始时间
	...
	@Override
	@Transactional(isolation = Isolation.READ_COMMITTED, propagation = Propagation.REQUIRED)
	public int grapRedPacketForVersionCountRe(Long redPacketId, Long userId) {
		for (int i = 0; i < 3; i++) {
			// 获取红包信息，注意version值
			RedPacket redPacket = redPacketDao.getRedPacket(redPacketId);
			// 当前小红包库存大于0
